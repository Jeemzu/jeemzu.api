...
Available agents:
- "knowledge": Handles questions about James (his skills, experience, projects, education, personal info, strengths, qualifications, fit for roles). Uses a vector database of James's personal information.
- "game_stats": Handles questions about game leaderboards, scores, user profiles, and game statistics. Available games: snake, tetris, pong, brickbreak, zaim.
